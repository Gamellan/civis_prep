...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'es': {
      ...
      'mockExam': 'Simulacro',
      'mockExamPreparation': 'Preparación del simulacro: {mode}',
      'mockMode': 'Modo: {mode}',
      'mockDuration': 'Duración: {minutes} minutos',
      'mockQuestionCount': 'Preguntas: {count}',
      'readBeforeStart': 'Lectura recomendada: 10–15 segundos antes de empezar.',
      'quickRules': 'Reglas rápidas',
      'quickRuleFlag': '• Puedes marcar preguntas dudosas y revisarlas al final.',
      'quickRuleAutosave': '• El progreso se guarda automáticamente durante el simulacro.',
      'quickRuleReview': '• Antes de entregar, verás una pantalla de revisión final.',
      'startMockExam': 'Empezar simulacro',
      'modeSelection': 'Selecciona modo de simulacro',
      'quickModeSubtitle': '10 preguntas · 15 minutos',
      'officialModeSubtitle': '25 preguntas · 45 minutos',
      'quickMode': 'Rápido',
      'officialMode': 'Oficial',
      'resumeQuick': 'Reanudar rápido',
      'resumeOfficial': 'Reanudar oficial',
      'mockResumed': 'Simulacro reanudado automáticamente.',
      'mockExamCompleted': 'Simulacro finalizado',
      'answeredSummary': 'Has respondido {answered} de {total} preguntas.',
      'correctSummary': 'Aciertos: {count}',
      'incorrectSummary': 'Fallos: {count}',
      'percentageSummary': 'Porcentaje: {value}%',
      'detailLabel': 'Detalle:',
      'correctChoiceLabel': 'Correcta: {answer}',
      'userChoiceLabel': 'Tu respuesta: {answer}',
      'statusCorrect': '✅ Correcta',
      'statusIncorrect': '❌ Incorrecta',
      'explanationLabel': 'Explicación: {text}',
      'homeHeroSubtitle':
      ...
      'studyPlanTask1': '10 minutos de repaso de preguntas CCSE.',
      'studyPlanTask2': '10 minutos de práctica DELE A2.',
      'studyPlanTask3': '5 minutos de flashcards para reforzar conceptos.',
      'studyPlanTask4': 'Finaliza con una reflexión breve sobre lo aprendido.',
      'dailyGoalCompleted': 'Meta diaria completada.',
      'goodProgress': 'Buen progreso, sigue así.',
      'startWithFirstTask': 'Empieza con la primera tarea.',
      'loadingYourStreak': 'Cargando tu racha...',
      'recommendedRoutine': 'Rutina recomendada',
      'currentStreak': 'Racha actual: {value} días',
      'bestStreak': 'Mejor racha: {value} días',
      'weeklySummary': 'Resumen semanal',
      'dailyProgress': 'Progreso diario',
      'tasksCompleted': '{completed}/{total} tareas completadas',
      'today': 'Hoy',
      'backToHome': 'Volver al inicio',
      'allUpToDate': 'Todo está al día',
      'noPendingFlashcards': 'No tienes flashcards pendientes por revisar ahora.',
      'reload': 'Recargar',
      'showAnswer': 'Mostrar respuesta',
      'hideAnswer': 'Ocultar respuesta',
      'nextCard': 'Siguiente',
      'markAsRemembered': 'Marcar como recordada',
      'cardNumber': 'Tarjeta {current}/{total}',
      'practiceSectionTitle': 'Cómo trabajar esta sección',
      'listeningStep1': 'Escucha o lee la frase de apoyo.',
      'listeningStep2': 'Identifica la intención del hablante.',
      'listeningStep3': 'Elige la respuesta más adecuada entre las opciones.',
      'listeningStep4': 'Comprueba la explicación para reforzar el aprendizaje.',
    ...
    'en': {
      ...
      'mockExam': 'Mock exam',
      'mockExamPreparation': 'Mock exam prep: {mode}',
      'mockMode': 'Mode: {mode}',
      'mockDuration': 'Duration: {minutes} minutes',
      'mockQuestionCount': 'Questions: {count}',
      'readBeforeStart': 'Recommended read: 10–15 seconds before starting.',
      'quickRules': 'Quick rules',
      'quickRuleFlag': '• You can flag doubtful questions and review them at the end.',
      'quickRuleAutosave': '• Progress is saved automatically during the mock exam.',
      'quickRuleReview': '• Before submitting, you will see a final review screen.',
      'startMockExam': 'Start mock exam',
      'modeSelection': 'Select mock mode',
      'quickModeSubtitle': '10 questions · 15 minutes',
      'officialModeSubtitle': '25 questions · 45 minutes',
      'quickMode': 'Quick',
      'officialMode': 'Official',
      'resumeQuick': 'Resume quick',
      'resumeOfficial': 'Resume official',
      'mockResumed': 'Mock exam resumed automatically.',
      'mockExamCompleted': 'Mock exam finished',
      'answeredSummary': 'You answered {answered} of {total} questions.',
      'correctSummary': 'Correct: {count}',
      'incorrectSummary': 'Incorrect: {count}',
      'percentageSummary': 'Percentage: {value}%',
      'detailLabel': 'Details:',
      'correctChoiceLabel': 'Correct: {answer}',
      'userChoiceLabel': 'Your answer: {answer}',
      'statusCorrect': '✅ Correct',
      'statusIncorrect': '❌ Incorrect',
      'explanationLabel': 'Explanation: {text}',
      'homeHeroSubtitle':
      ...
      'studyPlanTask1': '10 minutes of CCSE question review.',
      'studyPlanTask2': '10 minutes of DELE A2 practice.',
      'studyPlanTask3': '5 minutes of flashcards to reinforce concepts.',
      'studyPlanTask4': 'Finish with a brief reflection on what you learned.',
      'dailyGoalCompleted': 'Daily goal completed!',
      'goodProgress': 'Good progress, keep going.',
      'startWithFirstTask': 'Start with the first task.',
      'loadingYourStreak': 'Loading your streak...',
      'recommendedRoutine': 'Recommended routine',
      'currentStreak': 'Current streak: {value} days',
      'bestStreak': 'Best streak: {value} days',
      ...
      'noPendingFlashcards': 'You have no flashcards pending to review right now.',
      'reload': 'Reload',
      'showAnswer': 'Show answer',
      'hideAnswer': 'Hide answer',
      'nextCard': 'Next',
      'markAsRemembered': 'Mark as remembered',
      'cardNumber': 'Card {current}/{total}',
      'practiceSectionTitle': 'How to work on this section',
      'listeningStep1': 'Listen to or read the support sentence.',
      'listeningStep2': 'Identify the speaker\'s intention.',
      'listeningStep3': 'Choose the most suitable answer among the options.',
      'listeningStep4': 'Check the explanation to reinforce learning.',
